...
public class AmazonInc {
    public static void main(String[] args) {
        ...
        ProductOwner po = new ProductOwner("Suhaib",29,'M',1,160000,"");
        ...
        ScrumTeam scrumTeam = new ScrumTeam(po, ba, sm);//bu object te po,ba,sm,developers,testers hepsini iceriyor
        ...
        //every scrum team deki tester larin isimlerini print yapmak icin
        ...
        //every scrum team deki developer larin isimlerini print yapmak icin
