...
public class StringMethodsEmptyBlankEquel {
    public static void main(String[] args) {

        String str = " ";//eger bosluk birakmzasak true cikicak
        ...
        //in order to ignore the case sensitivity we first create the lower case/upper case version of string  and then compare it with lowercase and uppercase
