...
public class Day10_HTTPStatusCodeTernary {
    public static void main(String[] args) {
        ...
        String result = (status == 200) ? "OK" :(status == 201) ? "Created" :(status == 202) ? "Accepted":(status == 301) ? "Moved Permanently"
                      ...
                      :(status == 410) ? "Gone" :(status == 500) ? "Internal Server Error": "Service Unavailable";
